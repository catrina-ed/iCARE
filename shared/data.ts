...
export const GAIL: CareRecipient = {
  ...
  age: 78,
  pronouns: 'she/her',
  // Placeholders on purpose. Real conditions, allergies, and medications
  // belong in the database behind row-level security, never in this repo.
...
export const ALERTS_MORNING_ALERT: Alert[] = [
  ...
  },
  {
    ...
    type: 'supplies',
    severity: 'warn',
    title: 'Medication C running low',
...
export const SHOPPING_ITEMS: ShoppingItem[] = [
  { id: 's1', name: 'Nutrition shakes', category: 'groceries', status: 'needed', recurring: true, recurringInterval: 14 },
  ...
  { id: 's6', name: 'Personal care supplies', category: 'medical', status: 'needed' },
];
